...
const NewEvent = () => {
  ...
  const chooseAmount = (role) => {
    ...
    if (role.target.checked === true)
      ...
      setEventStringsRoles(eventStringsRoles => eventStringsRoles.filter((roleInList) => {
  ...
  return (
    <div>
      ...
      <div className="box container">
        <h1 className="event-details__title title container">הוספת אירוע חדש</h1>
      </div>
          ...
          <div className="container">
            ...
            <form onSubmit={addEvent}>
              ...
              <div className="form__group">
                ...
                <select className="form__input" onChange={(e) => setType(e.target.value)} required>
              ...
              <button className="edit-btn btn--accent"
                type="submit"
              >
